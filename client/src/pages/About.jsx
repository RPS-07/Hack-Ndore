    ...
    <div>
      ...
      <section className="bg-richblack-700">
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
            ...
            <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">  Driving Innovation in Online Way for a  <HighlightText text={"Tax assesment"} />
                <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[85%]">The revenue department of municipal corporations plays a critical role in ensuring the financial health of urban areas by collecting taxes, fees, and other revenue sources. Our robust revenue management system is designed to enhance the efficiency and accuracy of revenue collection and management. </p>             
            </header>
